...
<html lang="en">
  ...
  <body>
        ...
        <a class="navbar-brand" href="#"><h3><b>Review Cenah</b></h3></a>
        </nav>
        ...
        <div class="card">
            ...
            <form action="../guru/proses.php" method="post">
                ...
                <input type="hidden" name="no" value="<?php echo $no; ?>">
                    ...
                    <button type="submit" name="save" class="btn btn-primary"><b>Simpan</b></button>
                    <br><br>
                    <a href="index.php" class="btn btn-secondary"><b><- Kembali</b></a>
                </form>
