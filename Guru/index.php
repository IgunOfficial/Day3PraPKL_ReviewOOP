...
<html lang="en">
  ...
  <body>
        ...
        <a class="navbar-brand" href="#"><b><i><h3>Review Cenah</h3></i></b></a>
...
<br>
        <center><h2><b><i>GURU</i></b></h2></center>
        <!-- CARDs -->
        <div class="container">
        <div class="card">
            <div class="card-header" style="background-color: #5F9EA0;">
                <h3>Data Guru</h3>
                <center><a href="create.php" class="btn btn-primary"><b>Tambah Data</b></a></center>
            </div>
                ...
                <table class="table table-success table-striped" style="text-align:center">
                    ...
                    <tbody>
                        ...
                        <td>
                            ...
                            <a href="show.php?no=<?php echo $data['no']; ?>" class="btn btn-warning"><b>Show</b></a> ||
                            <a href="edit.php?no=<?php echo $data['no']; ?>" class="btn btn-success"><b>Edit</b></a> ||
